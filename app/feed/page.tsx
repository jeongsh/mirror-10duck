...
import FeedAttachmentCards from "@/components/community/feed/FeedAttachmentCards";
      ...
      <section className="flex flex-col">
        {loading ? (
          ...
          posts.map((post) => {
            ...
            const { body, imageUrls, shareHeaderLine, cards } = splitFeedBodyForDisplay(post.content);
            const authorHandle =
                    ...
                    {isBoardShareFeed ? (
                      <div className="mt-2 rounded border border-dashed border-gray-200 bg-gray-50/80 px-3 py-2.5">
                        <SharedPostOriginCard
                          ...
                          variant="unified"
                        />
                        {body || imageUrls.length > 0 || cards.length > 0 ? (
                          <div className="mt-2 border-t border-dashed border-gray-200 pt-2.5">
                            ...
                            <FeedAttachmentCards cards={cards} />
                          </div>
                        ) : null}
                      </div>
                    ) : (
